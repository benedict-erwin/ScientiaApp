...
class M_groupmenu extends \App\Plugin\DataTablesMysql
{
    ...
    public function __construct(\Slim\Container $container)
    {
        ...
        /* Table Setup */
        $this->setTable('m_groupmenu')
            ->setColumns(['id_groupmenu', 'nama', 'icon', 'urut', 'aktif'])
            ->setPkey('id_groupmenu')
            ->setSearchCols(['nama', 'icon'])
            ->setDefaultOrder(['urut' => 'ASC']);
    }

    /**
     * Get Data in M_groupmenu by Primary Key
     *
     * @param integer $id
     * @return array
     */
    ...
    /**
     * Retrieve data from M_groupmenu
     *
     * @param array $data
     * @return array $output
     */
    ...
    /**
     * Remove single or multiple data from M_groupmenu
     *
