/* Variables */;
var apiUrl = SiteRoot + "c_configure";
...
$(document).ready(function() {
	...
	$("input[name=description]").enterKey(function (e) {
		e.preventDefault();
		$(".btn_save").click();
	});
	...
	table = $("#datatable-responsive").DataTable({
		...
		"buttons": [
			...
			},
			{
				...
				exportOptions: {
					/* Show column */
					columns: [1, 2, 3, 4] /* [1, 2, 3] => selected column only */
				},
