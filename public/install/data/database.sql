...
INSERT INTO `m_config` (`id_config`, `name`, `value`, `description`, `scope`) VALUES
(1,	'asd',	'asd',	'asd',	1),
(2,	'tess',	'ssss',	'asdasd',	1);
...
(5,	1,	'Home',	'',	'/home',	'',	'MENU',	1,	0,	0),
(6,	3,	'Generator',	'',	'/generator',	'',	'MENU',	1,	6,	0),
(7,	3,	'CRUD Generator',	'',	'/crud_gen',	'CRUDGenerator:index',	'POST',	1,	1,	0),
(8,	2,	'Role',	'',	'/role',	'',	'MENU',	1,	0,	0),
(9,	2,	'Api Role Get By ID',	'',	'/role',	'M_role:get',	'GET',	1,	2,	0),
...
(15,	2,	'User',	'',	'/user',	'',	'MENU',	1,	1,	0),
(16,	2,	'Api User Get By ID',	'',	'/user',	'M_user:get',	'GET',	1,	1,	0),
...
(22,	2,	'Groupmenu',	'',	'/groupmenu',	'',	'MENU',	1,	3,	0),
(23,	2,	'Api Groupmenu Get By ID',	'',	'/groupmenu',	'M_groupmenu:get',	'GET',	1,	3,	0),
...
(29,	2,	'Menu',	'',	'/menu',	'',	'MENU',	1,	4,	0),
(30,	2,	'Api Menu Get By ID',	'',	'/menu',	'M_menu:get',	'GET',	1,	4,	0),
...
(38,	2,	'Config',	'',	'/config',	'',	'MENU',	1,	5,	0),
(39,	2,	'Api Config Get By ID',	'',	'/config',	'M_config:get',	'GET',	1,	5,	0),
...
(45,	3,	'Auditlog',	'',	'/auditlog',	'',	'MENU',	1,	7,	0),
(46,	3,	'Api Auditlog Get By ID',	'',	'/auditlog',	'L_auditlog:get',	'GET',	1,	2,	0),
