...
(50,	2,	'Api User Get Profile',	NULL,	'/user/profile',	'M_user:getProfile',	'GET',	1,	0,	0),
(51,	2,	'Api User Update Profile',	NULL,	'/user/update_profile',	'M_user:updateProfile',	'POST',	1,	0,	0);
